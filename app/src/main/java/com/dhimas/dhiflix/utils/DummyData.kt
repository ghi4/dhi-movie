    ...
    fun generateDummyMovies(): ArrayList<ShowEntity> {
        ...
        movies.add(
            ShowEntity(
                ...
                R.drawable.poster_bare_bears,
                R.drawable.backdrop_bare_bears
            )
        )
        ...
        movies.add(
            ShowEntity(
                ...
                R.drawable.poster_greyhound,
                R.drawable.backdrop_greyhound
            )
        )
    ...
    fun generateDummySeries(): ArrayList<ShowEntity> {
        ...
        series.add(
            ShowEntity(
                ...
                R.drawable.backdrop_the_simpson
            )
        )
        ...
        series.add(
            ShowEntity(
                ...
                R.drawable.poster_the_good_doctor,
                R.drawable.backdrop_the_good_doctor
            )
        )
        ...
        series.add(
            ShowEntity(
                ...
                R.drawable.poster_the_mentalist,
                R.drawable.backdrop_the_mentalist
            )
        )
        ...
        series.add(
            ShowEntity(
                ...
                R.drawable.poster_teen_wolf,
                R.drawable.backdrop_teen_wolf
            )
        )
        ...
        series.add(
            ShowEntity(
                ...
                R.drawable.poster_grim,
                R.drawable.backdrop_grim
            )
        )
        ...
        series.add(
            ShowEntity(
                ...
                R.drawable.poster_starwars_the_mandalorian,
                R.drawable.backdrop_starwars_the_mandalorian
            )
        )
        ...
        series.add(
            ShowEntity(
                ...
                R.drawable.poster_prison_break,
                R.drawable.backdrop_prison_break
            )
        )
